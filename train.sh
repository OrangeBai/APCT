...
CUDA_VISIBLE_DEVICES=0 python train.py  --world_size 1 --dataset imagenet --attack noise --sigma 0.10 --exp_id noise_010 --resume 0 --num_epoch 15 --net resnet50 --print_every 10
# CUDA_VISIBLE_DEVICES=1 python train.py  --world_size 1 --dataset imagenet --attack noise --sigma 0.0 --exp_id std --resume 0 --num_epoch 15 --net resnet50 --print_every 10
